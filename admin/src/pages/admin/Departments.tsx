...
const Departments = () => {
  ...
  const fetchDepartments = async () => {
    try {
      const res = await axios.get("https://api.biziffy.comapi/departments");
  ...
  const handleAddDepartment = async () => {
    ...
    try {
      await axios.post("https://api.biziffy.comapi/departments", {
  ...
  const handleDelete = async (id: string) => {
    try {
      await axios.delete(`https://api.biziffy.comapi/departments/${id}`);
  ...
  const handleUpdate = async () => {
    ...
    try {
      await axios.put(`https://api.biziffy.comapi/departments/${selectedDept._id}`, {

...
const EditPinCode = () => {
    ...
    const fetchPinCodes = async () => {
        try {
            const response = await axios.get(`https://api.biziffy.comapi/pincode/get-all-pin-codes-by-id/${id}`);
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            const res = await axios.post(`https://api.biziffy.comapi/pincode/update-pincode/${id}`, formData);
            if (res.data.status) {

...
export const AllWebsiteListing = () => {
    ...
    const fetchFullListings = async () => {
        ...
        setError(null);
        try {
            const res = await axios.get(`https://api.biziffy.comapi/admin/get-all-website-listings`);
    ...
    const handleBulkAction = async () => {
        ...
        try {
            const data = await axios.post(`https://api.biziffy.comapi/admin//website-listing-bulk-action`, {
    ...
    const handleUpdateStatus = async (id: string, newStatus: string) => {
        ...
        try {
            await axios.post(`https://api.biziffy.comapi/admin/update-website-listing-status/${id}`, { status: newStatus });
            setFullListings(
    ...
    const handleDeleteListing = async (id: string) => {
        ...
        try {
            const response = await axios.get(`https://api.biziffy.comapi/admin/delete-website-listing/${id}`);

...
const Membership = () => {
  ...
  useEffect(() => {
    const fetchMemberships = async () => {
      try {
        const res = await axios.get("http://localhost:18001/api/admin/memberships");
  ...
  const handleDelete = async (id: string) => {
    try {
      await axios.delete(`http://localhost:18001/api/admin/memberships/${id}`); // API call to delete

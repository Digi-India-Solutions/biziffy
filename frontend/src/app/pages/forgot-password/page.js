...
const Page = () => {
    ...
    const handleEmailSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:18001/api/auth/send-otp', { email });
    ...
    const handleOtpSubmit = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:18001/api/auth/verify-otp', { email, otp });
    ...
    const handlePasswordReset = async (e) => {
        ...
        try {
            const res = await axios.post('http://localhost:18001/api/auth/reset-password', {
                email,
                newPassword
            });

...
const bussinesslisting = () => {
  ...
  //       response = await axios.get("http://api.biziffy.com/api/search-listings", {
  //         params: { pincode, query, title },
  //       });
  //     }
  //     // else {
  //     //   response = await axios.get("http://api.biziffy.com/api/get-all-listings");
  //     // }
  ...
  //     let response;
  //     if (pincode || query || title) {
  //       response = await axios.get("http://api.biziffy.com/api/admin/search-website-listings", {
  //         params: { pincode, query, title },
  //       });
  //     }
  ...
  const handleCountClick = (type, businessId) => {
    ...
    if (!lastClickDay || parseInt(lastClickDay) < currentDay) {
      ...
      axios.post(`http://api.biziffy.com/api/increase-click-count/${businessId}`, { type, user })

...
export default function EditWebsiteProfile({ listingId }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post(`http://api.biziffy.com/api/admin/update-website-listings-by-id/${listingId?._id}`, form);
    ...
    useEffect(() => {
        const fetchCategory = async () => {
            try {
                const response = await axios.get("http://api.biziffy.com/api/categories");
        ...
        if (formData?.category) {
            const fetchSubCategory = async () => {
                try {
                    ...
                    const response = await axios.get(`http://api.biziffy.com/api/admin/get-Subcategories-by-category/${formData?.category}`);
    ...
    useEffect(() => {
        const fetchAreas = async () => {
            try {
                const res = await axios.get(`http://api.biziffy.com/api/pincode/get-areapincode-by-state`, {

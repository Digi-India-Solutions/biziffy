...
export default function EditBusinessProfile({ listingId }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(`http://api.biziffy.com/api/update-listings-by-id/${listingId?._id}`, form);
    ...
    if (formData.businessCategory) {
      const fetchSubCategory = async () => {
        try {
          ...
          const response = await axios.get(`http://api.biziffy.com/api/admin/get-Subcategories-by-category/${formData.businessCategory}`);
